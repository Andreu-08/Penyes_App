<div class="box mt-5">
    ...
    <table class="table is-fullwidth is-hoverable is-striped">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $lastCrews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><?php echo e($crew->name); ?></td>
                    <td><?php echo e($crew->created_at->format('d/m/Y H:i')); ?></td>
                    <td>
...
<?php /**PATH /var/www/html/resources/views/back/partials/lastCrews.blade.php ENDPATH**/ ?>
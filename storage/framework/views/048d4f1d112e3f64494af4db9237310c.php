                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif($user->crews()->wherePivot('confirmed', false)->exists()): ?>
                                    <a href="<?php echo e(route('back.users.show', $user->id)); ?>" class="button is-warning">Solicitud Pendiente</a>
                                <?php else: ?>
                                    Sin peña
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                ...
                                <div style="display: flex; align-items: center; gap: 8px; flex-wrap: nowrap;">
                                    ...
                                    <form action="<?php echo e(route('back.users.destroy', $user->id)); ?>" method="POST" style="display: inline;">
                                        ...
                                        <button type="submit"
                                            onclick="deleteUser(event, <?php echo e($user->id); ?>)"
